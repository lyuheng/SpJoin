...
ifbinstream &operator<<(ifbinstream &m, int64_t i)
{
...
template <class T>
ifbinstream &operator<<(ifbinstream &m, const std::vector<T> &v)
{
    m << v.size();
...
template <>
ifbinstream &operator<<(ifbinstream &m, const std::vector<int> &v)
{
    m << v.size();
...
template <>
ifbinstream &operator<<(ifbinstream &m, const std::vector<double> &v)
{
    m << v.size();
...
template <class T>
ifbinstream &operator<<(ifbinstream &m, const std::set<T> &v)
{
    m << v.size();
...
ifbinstream &operator<<(ifbinstream &m, const std::string &str)
{
    m << str.length();
...
ifbinstream &operator<<(ifbinstream &m, const std::map<KeyT, ValT> &v)
{
    m << v.size();
...
ofbinstream &operator>>(ofbinstream &m, int64_t &i)
{
...
template <class T>
ofbinstream &operator>>(ofbinstream &m, std::vector<T> &v)
{
    size_t size;
    m >> size;
    v.resize(size);
...
template <>
ofbinstream &operator>>(ofbinstream &m, std::vector<int> &v)
{
    size_t size;
    m >> size;
...
template <>
ofbinstream &operator>>(ofbinstream &m, std::vector<double> &v)
{
    size_t size;
    m >> size;
...
template <class T>
ofbinstream &operator>>(ofbinstream &m, std::set<T> &v)
{
    size_t size;
    m >> size;
...
ofbinstream &operator>>(ofbinstream &m, std::string &str)
{
    size_t length;
    m >> length;
    str.clear();
...
template <class KeyT, class ValT>
ofbinstream &operator>>(ofbinstream &m, std::map<KeyT, ValT> &v)
{
    size_t size;
    m >> size;
    for (size_t i = 0; i < size; i++)
...
template <class KeyT, class ValT>
ofbinstream &operator>>(ofbinstream &m, std::unordered_map<KeyT, ValT> &v)
{
    size_t size;
    m >> size;
    for (size_t i = 0; i < size; i++)
...
template <class T>
ofbinstream &operator>>(ofbinstream &m, std::unordered_set<T> &v)
{
    size_t size;
    m >> size;
    for (size_t i = 0; i < size; i++)
